...
async function createPayment(transactionAmount, data){
    ...
    try {
      ...
      const hashString = key + '|' + transactionId + '|' + transactionAmount + '|' + productinfo + '|' + firstName + '|' + email + '|' + udf.udf1 + '|' + udf.udf2 + '|' + udf.udf3 + '|' + udf.udf4 + '|' + udf.udf5 + '|' + udf.udf6 + '|' + udf.udf7 + '|' + udf.udf8 + '|' + udf.udf9 + '|'+ udf.udf10 + '|' + salt;
